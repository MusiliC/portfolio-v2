          ...
          <div className="md:w-1/2 mt-6 md:mt-0 py-4 ">
            ...
            <div className="flex  justify-between items-center  mx-auto w-[90%] mt-14 ">
              <button
                ...
                className=" bg-transparent  lg:text-2xl py-3  px-6 lg:px-10 hover:bg-blue-500 text-blue-700 font-bold hover:text-white  border border-blue-500 hover:border-transparent rounded"
              >
                Download CV
              </button>
